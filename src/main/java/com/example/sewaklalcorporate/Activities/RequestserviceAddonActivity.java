...
public class RequestserviceAddonActivity extends BaseAppCompatActivity {
    protected Toolbar toolbar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_requestservice_addon);
        initToolBar("Add Services Request", true);
    }
